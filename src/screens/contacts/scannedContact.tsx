...
type ScannedContactScreenProps = NativeStackScreenProps<
  SendStackParamList,
  'ContactScan'
>;

export const ScannedContactScreen = ({ route}: ScannedContactScreenProps) => {
    const { profilePicture, username, quaiAddress, qiPaymentCode } = route.params;
  ...
  const addToContacts = () => {
    ...
    console.log('add to contacts', newContact);
  ...
  return (
    <ContentComponent title='Scanned Contact'>
